...
(ID_SEXO INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY
,DE_SEXO VARCHAR(64)
,FC_INSERT DATETIME
,FC_MODIFICACION DATETIME
);
...
/*EL CASO POR EL CUAL SE HACE ESTE MODELO DE CLASIFICACION DE LOCALIDADES ES PORQUE HAY CASOS EN LOS QUE VARIOS ESTADOS TIENEN UNA CIUDAD CON IGUAL NOMBRE
POR LO QUE ES NECESARIO LIGAR CADA CIUDAD A SU RESPECTIVO ESTADO PARA QUE NO HAYA CONFUSIONES*/
